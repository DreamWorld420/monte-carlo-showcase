...
export default function BuffonNeedlePage() {
  ...
  const piEstimate = total > 0 && crosses > 0 ? (2 * needleLength * total) / (lineSpacing * crosses) : 0
  ...
  useEffect(() => {
    ...
    ctx.strokeStyle = isDark ? "#718096" : "#cbd5e1"
    ctx.lineWidth = 2
      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 md:gap-8">
          <Card className="h-fit">
            <CardHeader>
              <CardTitle className="text-2xl md:text-3xl">Buffon's Needle</CardTitle>
              <CardDescription>Estimate π by dropping needles on parallel lines</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <div className="space-y-4 md:space-y-6">
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-accent/50 rounded-lg p-4">
                    ...
                    <p className="text-2xl font-bold text-chart-1">{crosses.toLocaleString()}</p>
                  </div>
                  <div className="bg-accent/50 rounded-lg p-4">
                    <p className="text-sm text-muted-foreground">Total Needles</p>
                ...
                <div className="bg-accent/50 rounded-lg p-4">
                  <p className="text-sm text-muted-foreground">Probability of Crossing</p>
                  <p className="text-xl font-bold">{total > 0 ? ((crosses / total) * 100).toFixed(2) : "0.00"}%</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Slider value={[speed]} onValueChange={(v) => setSpeed(v[0])} min={1} max={20} step={1} />
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="text-sm text-muted-foreground space-y-2">
                ...
                <p className="text-xs">L = needle length, d = line spacing, N = total drops, C = crossings</p>
              </CardContent>
            </Card>
          </div>
        </div>
