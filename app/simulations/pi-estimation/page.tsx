			...
			<div className="container mx-auto max-w-6xl">
				...
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-8 ">
					<Card className="h-fit">
						<CardHeader>
							<CardTitle className="text-3xl">Pi Estimation</CardTitle>
							<CardDescription>
								Using Monte Carlo method with random points
							</CardDescription>
						</CardHeader>
						<CardContent>
						...
						<Card>
							...
							<CardContent className="text-sm text-muted-foreground space-y-2">
								...
								<p className="pt-2 text-xs">
									The more points generated, the more accurate the estimation
									becomes.
								</p>
							</CardContent>
						</Card>
